# plataforma_ead
Plataforma Administrativa para realizar a matrícula de alunos em cursos.


O login no Sistema pode ser realizado através do usuário: admin@admin.com e a senha: 123
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_code`, `forgotten_password_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
     ('1','127.0.0.1','administrator','123','admin@admin.com','',NULL,'1268889823','1268889823','1', 'Admin','istrator','ADMIN','0');
...
CREATE TABLE `materias` (
  ...
  `materia_ativa` tinyint(1) DEFAULT NULL,
  `materia_data_alteracao` timestamp
);
